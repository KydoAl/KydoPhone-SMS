...
fun HomeScreen(
    ...
    Scaffold(
        ...
        Column(Modifier.fillMaxSize().padding(padding)) {
            ...
            // Keep tab switching immediate; the old fade animation made the dialer
            // feel slower on lower-end devices.
            when (tab) {
                ...
                TAB_CONTACTS -> ContactsTab(vm, contactsState, openContact)
